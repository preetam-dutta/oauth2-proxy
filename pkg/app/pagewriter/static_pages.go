...
func (s *staticPageWriter) WriteRobotsTxt(rw http.ResponseWriter) {
	s.writePage(rw, robotsTxtName)
}

// writePage writes the content of the page to the response writer.
func (s *staticPageWriter) writePage(rw http.ResponseWriter, pageName string) {
